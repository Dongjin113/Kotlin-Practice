...
//class Chap9KotlinClass constructor(name: String, age:Int){
...
class Chap9KotlinClass2 (val name: String, var age:Int){
    ...
    override fun toString(): String {
        return "Chap9KotlinClass2(name='$name', age=$age)"
    }
...
class Chap9KotlinClass3 (val name: String = "홍길동", var age:Int = 1){
    ...
    override fun toString(): String {
        return "Chap9KotlinClass3(name='$name', age=$age)"
    }
...
fun main() {
    //val person = Chap9KotlinClass1("둘리",100)
